<template>
  <div class="main">
    ...
    <h3>VR Explorer</h3>
    <p style="margin:auto 15vw;">Take a look around! In this challenge you need to visit every node in order to collect information around securing containers to reveal the escape clue. <a>Hint: move the focus dot onto the nodes you want to visit.</a></p>
  ...
  data(){
    return{
      ...
      content:[
        ...
        {title:"Differentiators", description:"Nexus Container is the ONLY full lifecycle container security platform that performs all of these key functions: ", list:["Scans images and platform for vulnerabilities and compliance misconfigurations from dev to production", "Automatically inspects and learns all network traffic at Layer 7 and all processes on every container.", "This automatically generates security policies to create a zero-trust environment where ANY anomalous behavior can be identified, alerted on, or blocked."]},
        {title:"Cloud Support",   description:"Runs on all major cloud platforms including", list:["AWS", "Azure", "Google Cloud Platform"], footer:"Supporting all cloud-native frameworks."},
