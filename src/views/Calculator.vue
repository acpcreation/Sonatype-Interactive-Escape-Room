<template>
  <div class="main">
    ...
    <p>In this challenge you will calculate the answer to the various equations below. Each of these equations require different mathematical priciples to determine the correct answer.</p>
