...
export default {
  ...
  data(){
    return{
      prices:[
        {icon:"fa-ship", low:300, high:500,  submission:400,  answer:450, append:"Billion Dollars", step:10, question:"How profitable is cybercrime each year?", answerText:"Cyber crime profits $450 Billion each year while the drug trade only profits $435 Billion.", complete:false, finalScore:0},
        {icon:"fa-ship", low:.25, high:3,    submission:1.6,  answer:1,   append:"Dollars", step:.25, question:"How much does a malware installation kit cost to buy in the US?", answerText:"A malware kit cost $1.00 on the dark web vs $1.49 for gum.", complete:false, finalScore:0},
        ...
        {icon:"fa-ship", low:18,  high:1000, submission:518,  answer:18,   append:"Million Dollars", step:50, question:"What is the average cost of an attack on the banking industry per incident?", answerText:"Banking industry cost per incident is $18.37 Million.", complete:false, finalScore:0},
        {icon:"fa-ship", low:36,  high:212,  submission:138,  answer:196, append:"Days", step:16, question:"What is the average number of days it takes for a data breach to be detected?", answerText:"The average time to discover a data breach is 196 days. It took the Kon-Tiki expedition 101 day to raft from South America to Polynesia.", complete:false, finalScore:0},
        {icon:"fa-ship", low:10,  high:60,   submission:35,   answer:25,  append:"Percent", step: 5, question:" What is the percent of Americans who don’t know smart devices can be hacked?", answerText:"25% of Americans don’t know their phones can be hacked.", complete:false, finalScore:0},
